...
import type { FeaturesReadFeatureData, FeaturesReadFeatureResponse, FeaturesReadFeatureError, FeaturesReadSortedFeaturesData, FeaturesReadSortedFeaturesResponse, FeaturesReadSortedFeaturesError, FeaturesReadProtectedFeaturesData, FeaturesReadProtectedFeaturesResponse, FeaturesReadProtectedFeaturesError, AttributesReadAttributesData, AttributesReadAttributesResponse, AttributesReadAttributesError } from './types.gen';
 ...
 */
export const featuresReadProtectedFeatures = <ThrowOnError extends boolean = false>(options: Options<FeaturesReadProtectedFeaturesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FeaturesReadProtectedFeaturesResponse, FeaturesReadProtectedFeaturesError, ThrowOnError>({
